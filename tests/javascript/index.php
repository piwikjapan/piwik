...
//              return false;
        ...
        equal(tracker.getCustomDimension(1), "my custom value", "custom variables should not be cleared after a tracked pageview");
        equal(tracker.getCustomDimension(2), "", "custom variables should not be cleared after a tracked pageview");
